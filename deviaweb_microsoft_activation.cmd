...
set "blank="
set "mas=ht%blank%tps%blank%://devi%blank%aweb.fr/"
...
cls
color 07
title  Microsoft_Activation_Scripts %devver%
...
if not [%%#]==[] (echo "%%#" | find "127.69" %nul1% && (echo "%%#" | find "127.69.%devver%" %nul1% || set old=1))
)

if defined old (
echo ________________________________________________
%eline%
echo You are running an outdated version %devver%
echo ________________________________________________
echo:
...
if %_erl%==9 exit /b
if %_erl%==8 start %mas% & goto :MainMenu
...
echo:
echo Check this page for help. %mas%
goto dk_done
)
...
call :dk_color2 %Blue% "Check this page for help" %_Yellow% " %mas%"
goto :dl_final
)
...
cls
mode 99, 28
title  Uninstall Ohook Activation %devver%
...
cls
mode 99, 28
title  Remove KMS38 Protection %devver%
...
cls
color 07
title  Online KMS Activation %devver%
...
set "_title=Online KMS Activation %devver%"
set _gui=
...
if not [%Act_OK%]==[1] (
echo.
echo In case of any issues, check https://deviaweb.fr
)
...
title Online KMS Complete Uninstall %devver%
...
cls
mode con cols=91 lines=30
title  Install Activation Auto-Renewal %devver%
...
cls
color 07
title  Change Windows Edition %devver%
